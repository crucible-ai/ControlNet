...
class PNet(nn.Module):
    ...
    def __init__(self, pretrained=True, model_dir=None):
        super().__init__()
...
class MTCNN(nn.Module):
    ...
    def __init__(
            self, output_image_size=160, margin=0, min_face_size=20,
        ...
        self.pnet = PNet(model_dir=model_path)
        self.rnet = RNet(model_dir=model_path)
        self.onet = ONet(model_dir=model_path)
    ...
    def forward(self, img, save_path=None):
        ...
        Returns:
            Union[torch.Tensor, tuple(torch.tensor, float, torch.tensor, torch.tensor)] --
                If detected, cropped image of a face with dimensions 3 x image_size x image_size.
                The probability that a face was detected.
                The bounding boxes for each face.
                The facial landmarks of the face.
